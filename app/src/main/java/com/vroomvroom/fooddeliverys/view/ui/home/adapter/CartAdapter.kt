...
import com.vroomvroom.fooddeliverys.databinding.ItemCartBinding
...
class CartAdapter: ListAdapter<CartItemWithOptions, CartViewHolder>(CartDiffUtil()) {
    ...
    override fun onBindViewHolder(holder: CartViewHolder, position: Int) {
        ...
        val merchant = CartMerchantEntity(
            ...
            merchantlat = cartItem.cartMerchant.merchantlat,
            merchantlon = cartItem.cartMerchant.merchantlon
