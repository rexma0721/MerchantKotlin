...
import com.vroomvroom.fooddeliverys.databinding.FragmentMapsBinding
import com.vroomvroom.fooddeliverys.utils.ClickType
import com.vroomvroom.fooddeliverys.utils.Constants.DELIVERY_RANGE_CITIES
import com.vroomvroom.fooddeliverys.utils.Utils.createLocationRequest
import com.vroomvroom.fooddeliverys.utils.Utils.hasLocationPermission
import com.vroomvroom.fooddeliverys.utils.Utils.requestLocationPermission
import com.vroomvroom.fooddeliverys.utils.Utils.safeNavigate
import com.vroomvroom.fooddeliverys.utils.Utils.setSafeOnClickListener
import com.vroomvroom.fooddeliverys.utils.Utils.userLocationBuilder
import com.vroomvroom.fooddeliverys.view.ui.base.BaseFragment
import com.vroomvroom.fooddeliverys.view.ui.location.adapter.SuggestionAdapter
...
class MapsFragment : BaseFragment<FragmentMapsBinding>(
    ...
    private fun validateLocation(prevDestination: Int?) {
        ...
        if (newLatLng != null && newLatLng?.latitude != 0.0 && newLatLng?.longitude != 0.0 ) {
            Log.e("newLatLnglat", newLatLng?.latitude.toString())
            Log.e("newLatLng", newLatLng?.longitude.toString())
