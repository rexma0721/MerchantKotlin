...
import com.vroomvroom.fooddeliverys.data.db.Database
import com.vroomvroom.fooddeliverys.repository.local.UserPreferences
import com.vroomvroom.fooddeliverys.utils.Constants.CHANNEL_ID
import com.vroomvroom.fooddeliverys.utils.Constants.PREFERENCES_STORE_NAME
import com.vroomvroom.fooddeliverys.utils.Constants.VROOMVROOM_DATABASE
...
object RepoModule {
    ...
    fun getRetrofitInstance(httpClient: OkHttpClient): Retrofit {
        return Retrofit.Builder()
            .baseUrl("http://10.10.10.36:5000/api/v1/")
            .client(httpClient)
